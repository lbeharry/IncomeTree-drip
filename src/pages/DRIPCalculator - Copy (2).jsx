...
const Tooltip = ({ children, content }) => {
  ...
  return (
    <div className="relative inline-block">
      <span
        className="inline-flex items-center gap-1 cursor-help border-b border-dotted border-yellow-400 text-yellow-400"
      ...
      {isVisible && (
        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-sm rounded-lg shadow-lg border border-gray-600 max-w-xs z-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="bg-gradient-to-r from-yellow-600/20 to-orange-600/20 border border-yellow-500/30 rounded-xl p-6 mb-8">
          <div className="text-center">
            <h2 className="text-xl font-bold text-yellow-300 mb-2">2025 <Tooltip content="Tax-Free Savings Account contribution limits set by the Canadian government">TFSA Contribution Limits</Tooltip></h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-gray-800/50 rounded-lg p-4">
                <div className="text-2xl font-bold text-yellow-400">$7,000</div>
                <div className="text-sm text-gray-300">2025 Contribution Limit</div>
              </div>
              <div className="bg-gray-800/50 rounded-lg p-4">
              ...
              <div className="bg-gray-800/50 rounded-lg p-4">
                ...
                <div className="text-sm text-gray-300">Tax on Growth & Withdrawals</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="card">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xs bg-gray-700 text-gray-300 px-2 py-1 rounded">Educational</span>
              </div>
