...
import { Calculator, TrendingUp, DollarSign, PieChart, Save, Brain, CheckCircle, HelpCircle, Info, Target, Award, TrendingDown } from 'lucide-react'
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border-2 border-[#d4af37] rounded-lg px-4 py-2 bg-[#f6e6b4] text-[#192A3D] font-sans"
                    min="0"
                  />
